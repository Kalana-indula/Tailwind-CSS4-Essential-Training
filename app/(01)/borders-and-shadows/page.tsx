...
const Page = () => {
    return (
        <section className="p-8 bg-white shadow-lg rounded-lg shadow-indigo-300">
            ...
            <a className="underline underline-offset-4 text-indigo-500" href="https://www.tailwindcss.com">
                Learn more
            </a>
        </section>
    )
